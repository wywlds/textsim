...
if __name__=="__main__":
    ...
    product = tf.reduce_sum(tf.multiply(leftAverage, rightAverage), axis=1,keep_dims=True)/tf.norm(leftAverage, axis=1, keep_dims=True) / tf.norm(rightAverage, axis=1, keep_dims=True)
